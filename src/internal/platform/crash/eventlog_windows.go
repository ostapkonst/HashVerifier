...
const (
	...
	crashEventID = 1000
	// windowsEventLogMax keeps ReportEventW below its per-string limit (31,839 wide chars
	// per Microsoft docs); entries beyond this are truncated to retain the structured header.
